...
CUDA_VISIBLE_DEVICES=0 uv run python query_unlearned_model.py --run-dir selective_unlearning_runs/illiad/surprisal --output-file qual/iliad/surprisal/responses.json
CUDA_VISIBLE_DEVICES=0 uv run python query_unlearned_model.py --run-dir selective_unlearning_runs/illiad/emotion --output-file qual/iliad/emotion/responses.json
CUDA_VISIBLE_DEVICES=0 uv run python query_unlearned_model.py --run-dir selective_unlearning_runs/illiad/random --output-file qual/iliad/random/responses.json
